...
│   ├── tests/                      pytest-asyncio — 320 tests
...
Cobertura actual: **320 tests** en 27 archivos — identity, CRM, sales, inventory, workflows, portal, discovery, accounting, notifications, wedge smoke, e2e cross-module (tests unitarios + contrato + integración + e2e pipeline).
