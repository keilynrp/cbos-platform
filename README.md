...
│   ├── tests/                      pytest-asyncio — 264 tests
...
Cobertura actual: **264 tests** en 19 archivos — identity, CRM, sales, inventory, workflows, portal, discovery, accounting, notifications, wedge smoke, e2e cross-module (tests unitarios + contrato + integración).
