...
│   ├── tests/                      pytest-asyncio — 195 tests
...
Cobertura actual: **195 tests** en 14 archivos — identity, CRM, sales, inventory, workflows, portal, discovery, accounting, wedge smoke (tests unitarios + contrato + integración).
