...
│   ├── tests/                      pytest-asyncio — 262 tests
...
Cobertura actual: **262 tests** en 18 archivos — identity, CRM, sales, inventory, workflows, portal, discovery, accounting, notifications, wedge smoke (tests unitarios + contrato + integración).
