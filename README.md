...
│   ├── tests/                      pytest-asyncio — 190 tests
...
Cobertura actual: **190 tests** en 13 archivos — identity, CRM, sales, inventory, workflows, portal, discovery, accounting, wedge smoke (tests unitarios + contrato).
