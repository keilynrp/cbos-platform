...
│   ├── tests/                      pytest-asyncio — 284 tests
...
Cobertura actual: **284 tests** en 25 archivos — identity, CRM, sales, inventory, workflows, portal, discovery, accounting, notifications, wedge smoke, e2e cross-module (tests unitarios + contrato + integración + e2e pipeline).
